import { getPreference } from "@/domains/app-preferences/actions";
import { ArticleRetentionPreferenceForm } from "@/components/admin/settings/ArticleRetentionPreferenceForm";
import { EventsHistoryRetentionPreferenceForm } from "@/components/admin/settings/EventsHistoryRetentionPreferenceForm";
import { SyncJobHistoryRetentionPreferenceForm } from "@/components/admin/settings/SyncJobHistoryRetentionPreferenceForm";
import { Alert, AlertDescription } from "@/components/ui/alert";
import {
  ArticleRetentionPreference,
  EventsHistoryRetentionPreference,
  SyncJobHistoryRetentionPreference,
} from "@/domains/app-preferences/schemas";
